...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <img src="./assets/project1.svg" width="100%" alt="StegArmor Project Card" />
      <br /><br />
      <p><b>Key Highlights:</b> Multi-layered covert communication utility combining AES-256-GCM authenticated encryption with LSB spatial matrix pixel injection inside PNG carriers.</p>
    </td>
    <td width="50%" valign="top">
      <img src="./assets/project2.svg" width="100%" alt="Network Recon Suite Project Card" />
      <br /><br />
      <p><b>Key Highlights:</b> Automated network inspection tool designed for socket analysis, TCP/UDP port enumeration, banner grabbing, and packet structure auditing.</p>
    </td>
  </tr>
</table>
